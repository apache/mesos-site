...
In both types of reservations, resources are reserved for a [__role__](/documentation/latest/roles/).
...
see the [authorization documentation](/documentation/latest/authorization/).
